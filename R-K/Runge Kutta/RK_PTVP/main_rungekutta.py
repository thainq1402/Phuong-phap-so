...
#+Hàm y’=f(x,y)
#+Giá trị ban đầu x0
#+Giá trị ban đầu y(x0)
#+Khoảng cách h giữa 2 điểm liên tiếp
#+Số mốc n của lưới điểm
#+Số nấc của ct R-K(1,2,3,4 hoặc Heun)
#-Output:
#+Các điểm trên lưới và giá trị tương ứng
#+Đồ thị 
